# Code Quality Review - Shared Lead Procedure
...
When using workers, dispatch these 5 focused category workers:
...
When reviewing locally, load only the `code-smells` category guides that are
